package com.dongkap.notification.configuration.entrypoints;
...
public class ResourceServerNotificationAdapter extends ResourceServerConfigurerAdapter {
    ...
    private String resourceId = ResourceCode.NOTIFICATION;
    private String resourcePath = ResourceCode.NOTIFICATION_PATH;
    
    public ResourceServerNotificationAdapter() {}
    public ResourceServerNotificationAdapter(AccessDeniedHandler accessDeniedHandler, AuthenticationEntryPoint authenticationEntryPoint) {
